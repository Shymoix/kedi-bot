...
client.on("guildMemberAdd", async member => {
  var canvaskanal = member.guild.channels.cache.get(db.fetch(`wchnl_${member.guild.id}`));
  ...
  ctx.fillText(member.user.tag + ` sunucuya giriş yaptı.`, 550, 350)
  ...
  canvaskanal.send(`${member}, Aramıza Hoşgeldin! ✨`)
